...
public class Code extends ArrayList<Line> {
  ...
  /**
   * @param index
   *        Position at which to insert the row.
   * @param sb
   *        The StringBuilder of the line to insert.
   */
   ...
   * @param string
   *        The string from which to create a StringBuilder to insert.
   */
   ...
   *
   * @param s
   *        The string to append to the end of the code.
   * @return True, as specified in Collection.add(E).
   */
  ...
  /**
   * @param index
   *        The row index from which to retrieve the StringBuilder.
  ...
  public static interface CodeListener extends EventListener {
    /**
     * @param e
     *        The event representing the code change.
     */
  ...
  class FindResults {
     ...
     *
     * @param l
     *        The line on which the result was found.
     * @param p
     *        The position in the line at which the result was found.
     * @param L
     ...
     *
     * @param l
     *        The first line on which the result was found.
     * @param p
     *        The position in the line at which the result was found.
     * @param le
     *        The last line on which the result matched.
     * @param pe
     *        The position on the final line the marks the end of the result.
     */
  ...
  /**
   * @param findme
   *        The string to find, exploded at newlines.
   * @param lineFrom
   *        The line at which to begin searching.
   * @param posFrom
   *        The position in the line at which to begin searching.
  ...
  /**
   * @param sb
   *        The StringBuilder to search in.
   * @param findme
   *        The substring to find.
   * @param from
   *        The position at which to begin the search.
  ...
  public FindResults findNext(String[] findme, int lineFrom, int posFrom) {
    findMain: for (int y = lineFrom; y < size(); y++) {
      ...
      for (intermediate = 1; intermediate < findme.length - 1; intermediate++) {
        if (!findme[intermediate].equals(getsb(y + intermediate))) {
          continue findMain;
        }
      }
