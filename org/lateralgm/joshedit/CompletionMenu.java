...
public class CompletionMenu
{
	...
	public void reset()
	{
		...
		if (w.isEmpty()) options = completions;
	 ...
	 */
	public static class PopupHandler implements AWTEventListener, WindowListener,
		ComponentListener
	{
		protected Popup pop;
		...
		public void eventDispatched(AWTEvent ev)
		{
			...
			case MouseEvent.MOUSE_PRESSED:
				...
				if (UIManager.getBoolean("PopupMenu.consumeEventOnClose")) me
					.consume();
				break;
	...
	public abstract static class Completion
	{
		...
		public abstract boolean apply(JoshText a, char input, int row, int wordStart,
			int wordEnd);
	...
	private class KeyHandler extends KeyAdapter
	{
		...
		public void keyPressed(KeyEvent e)
		{
			...
			case KeyEvent.VK_BACK_SPACE:
				...
				else setSelectedText(new String());
				e.consume();
				reset();
				break;
