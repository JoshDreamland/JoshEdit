...
public class CPPTokenMarker extends DefaultTokenMarker {
  ...
  public CPPTokenMarker() {
    ...
    schemes.add(new BlockDescriptor("Comment", "/\\*", "\\*/", true, false, (char) 0, new Color(13,
        165, 13), Font.ITALIC));
    schemes.add(new BlockDescriptor("Formal C++ Comment", "//!", "$", true, false, (char) 0,
        new Color(128, 128, 255), Font.BOLD));
    schemes.add(new BlockDescriptor("Lazy Formal C++ Comment", "///", "$", true, true, '\\',
        new Color(128, 128, 255), Font.BOLD));
    schemes.add(new BlockDescriptor("C++ Comment", "//", "($)", true, true, '\\', new Color(13,
        165, 13), Font.ITALIC));
    ...
    otherTokens.add(new SimpleToken("Hex literal", "0[Xx][0-9A-Fa-f]+[FfUuLlDd]*", 0, new Color(
        255, 100, 100)));
    otherTokens.add(new SimpleToken("Numeric literal", "[0-9]+[FfUuLlDd]*", 0, new Color(255, 0,
        255)));
  }
