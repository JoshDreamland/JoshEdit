...
/** Static class to poll for GLSL keywords. */
public final class GLSLKeywords {
  ...
  static {
    ...
    try (InputStream is2 = GLSLKeywords.class.getResourceAsStream("glslfunctions.txt");) { //$NON-NLS-1$
