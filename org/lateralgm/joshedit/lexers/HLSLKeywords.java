...
/** Static class to poll for HLSL keywords. */
public final class HLSLKeywords {

  /** HLSL syntax construct keywords */
  public static final Construct[] CONSTRUCTS;
  /** HLSL operator keywords */
  public static final Operator[] OPERATORS;
  /** HLSL global variable names */
  ...
  static {
    ...
    try (InputStream is2 = HLSLKeywords.class.getResourceAsStream("hlslfunctions.txt")) { //$NON-NLS-1$
