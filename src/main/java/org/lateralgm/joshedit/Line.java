...
public class Line {
  ...
  /**
   * @param sb
   *        Construct a line from a string builder; set attributes to invalid.
   */
   ...
   *
   * @param tAttr
   *        The attribute for which to check.
   ...
   *
   * @param tAttr
   *        The OR of the attributes for which to check.
  ...
  /**
   * @param usAttr
   *        Unset an attribute on this line.
   */
