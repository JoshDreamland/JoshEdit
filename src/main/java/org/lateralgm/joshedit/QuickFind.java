...
public class QuickFind extends JToolBar implements FindNavigator {
  ...
  /**
   * @see org.lateralgm.joshedit.FindDialog.FindNavigator#updateParameters(java.lang.String,
   *      java.lang.String)
   */
  @Override
